...
ترافیک به‌صورت domain-fronted از Google Apps Script رد می‌شود و شبیه HTTPS عادی گوگل به نظر می‌رسد. Apps Script آن را به رله خروجی (VPS یا Cloudflare) می‌فرستد که به مقصد واقعی وصل می‌شود.
